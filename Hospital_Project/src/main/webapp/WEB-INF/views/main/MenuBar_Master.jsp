...
<html>
	<head>
		...
		<link rel="stylesheet" href="/hos/resources/css/menubar_master.css">
		...
		<div id="menubar" onmouseleave="hideMenubarContent()">
			<center>
				<img src="/hos/resources/images/임의의 로고.png" 
				     style="width: 50px; cursor: pointer; position: absolute; left: 500px;" 
			...
			<!-- 의료진 관리 호버 시 -->	
			<div id="professer_manage_content">
				<center>
